...
public class TheResult {
	public HashMap<String, Double> AttrGainMap = new HashMap<String, Double>();
	public HashMap<String, Double> AttrGainRatioMap = new HashMap<String, Double>();
	public ArrayList<AttributeClass> ResultList = new ArrayList<AttributeClass>();
	
	public TheResult( File file ) throws Exception {
		
		//读取文件并处理
		TextProcessing TextPro = new TextProcessing();
		TextPro.readFile(file);
		//计算得到EntropyS
